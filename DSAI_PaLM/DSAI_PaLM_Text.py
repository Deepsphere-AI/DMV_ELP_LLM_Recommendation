...
def DMVRecommendationPaLMText():
    ...
    if len(vAR_input)>8 or len(vAR_input)==0:
        ...
        vAR_response = ""
        try:
            vAR_response = DMVRecommendationPaLMTextModel(os.environ["PROJECT_ID"], vAR_input,"us-central1")
            ...
            with col2:
                vAR_st.write('')
                vAR_st.write("Exception Occurs - "+str(e))
