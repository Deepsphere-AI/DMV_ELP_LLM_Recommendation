...
def All_Initialization():
    ...
    choice2 =  st.sidebar.selectbox(" ",('Libraries in Scope','OpenAI','Vertex AI','Pandas','Streamlit','OS','Json'))
    choice3 =  st.sidebar.selectbox(" ",('Models Used',"Google's PaLM",'ChatGPT(GPT-4)','ChatGPT(GPT-3.5-turbo)', 'GPT3 - Davinci','GPT3 - Ada','GPT3 - Babbage','GPT3 - Curie'))
